...
export const SEED_PRODUCTS: SeedProduct[] = [
  ...
  { id: 'benton-peptide-serum', brand: 'Benton', name: 'Fermentation Eye Cream / Peptide Serum', category: 'serum',
    ageGroups: ['30s', '40s+'], concerns: ['fine lines', 'firmness'], ingredients: ['peptides', 'argireline'],
    priceUsd: 25, irritationRisk: 'low', timelineDays: 84, confidence: 'medium', isRx: false },
  { id: 'isntree-ha-gel-cream', brand: 'Isntree', name: 'Hyaluronic Acid Aqua Gel Cream', category: 'moisturizer',
    ageGroups: ['20s', '30s'], concerns: ['hydration', 'oily skin'], ingredients: ['hyaluronic acid'],
    priceUsd: 20, irritationRisk: 'low', timelineDays: 7, confidence: 'medium', isRx: false },
  { id: 'round-lab-dokdo-toner', brand: 'Round Lab', name: '1025 Dokdo Toner', category: 'toner',
    ageGroups: ['20s', '30s'], concerns: ['hydration', 'barrier repair', 'gentle exfoliation'], ingredients: ['deep sea water', 'panthenol'],
    priceUsd: 20, irritationRisk: 'low', timelineDays: 14, confidence: 'medium', isRx: false },
  ...
  { id: 'medik8-crystal-retinal', brand: 'Medik8', name: 'Crystal Retinal (retinaldehyde serum)', category: 'serum',
    ageGroups: ['40s+'], concerns: ['wrinkles', 'firmness', 'texture'], ingredients: ['retinaldehyde'],
    priceUsd: 60, irritationRisk: 'medium', timelineDays: 84, confidence: 'medium', isRx: false },
  { id: 'medipeel-peptide9', brand: 'MEDI-PEEL', name: 'Peptide 9 Volume / Bio-Tox Ampoule', category: 'ampoule',
    ageGroups: ['40s+'], concerns: ['wrinkles', 'sagging', 'mature skin'], ingredients: ['multi-peptide complex'],
    priceUsd: 30, irritationRisk: 'low', timelineDays: 84, confidence: 'medium', isRx: false },
  ...
  { id: 'purito-barrier-cream', brand: 'PURITO', name: 'Oat-In Calming Gel Cream / Bamboo Panthenol Cream', category: 'moisturizer',
    ageGroups: ['30s', '40s+'], concerns: ['dryness', 'barrier repair', 'sensitivity'], ingredients: ['panthenol', 'ceramides', 'niacinamide'],
    priceUsd: 20, irritationRisk: 'low', timelineDays: 14, confidence: 'medium', isRx: false },
  { id: 'peptide-eye-patches', brand: 'Various (MEDI-PEEL, Farmstay)', name: 'Hydrogel Peptide Eye Patches', category: 'eye',
    ageGroups: ['40s+'], concerns: ["crow's feet", 'under-eye fine lines', 'puffiness'], ingredients: ['peptides', 'hydrogel'],
    priceUsd: 20, irritationRisk: 'low', timelineDays: 28, confidence: 'medium', isRx: false },
