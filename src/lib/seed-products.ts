...
export const SEED_PRODUCTS: SeedProduct[] = [
  ...
  { id: 'benton-peptide-serum', brand: 'Benton', name: 'Peptide 9 EGF Serum', category: 'serum',
    ageGroups: ['30s', '40s+'], concerns: ['fine lines', 'firmness'], ingredients: ['9 peptides', 'EGF', 'argireline'],
